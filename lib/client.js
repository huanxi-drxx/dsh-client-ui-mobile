...
function BackgroundRow() {
      ...
      // Settings page managing the search-model list.
      ...
      ctx.effect(() => {
        ...
        const off10 = slots.inject("settings.section", () => slots.register({ name: "settings.section", id: "dshm-search-models", order: 16, label: () => t("searchModelsPage") }, SearchModelsPage));
