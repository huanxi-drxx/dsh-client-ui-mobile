window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /* Switch sheet: same width as the stock model menu instead of a full-width bar. */
    .dshm-search-model-sheet {
      left: 50% !important;
...
function BackgroundRow() {
      ...
      function ensureSearchModelRow() {
        ...
        for (const menu of menus) {
          ...
          // Single-line row styled exactly like the reasoning-level options:
          // one dark label, no grey id, no chevron.
