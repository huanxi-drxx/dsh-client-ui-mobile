...
function BackgroundRow() {
      ...
      function FilePickButton(props) {
        ...
        // Message edit/delete/regenerate: fetch editable blocks for THIS session
        // and inject the icons into each message action row. Runs from the
        // always-mounted plus-button occupant so it survives session switches.
        react.useEffect(() => {
