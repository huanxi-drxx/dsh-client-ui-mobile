window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .dshm-switch {
      ...
      border: none;
      border-radius: 11px;
      background: var(--dsw-alias-interactive-bg-hover, rgb(0 0 0 / 12%));
      cursor: pointer;
      transition: background 0.15s ease;
      -webkit-tap-highlight-color: transparent;
    }
    .dshm-switch[data-on="true"] { background: var(--dsw-alias-brand-primary, #2563eb); }
    ...
    .dshm-switch::after {
      ...
      height: 16px;
      border-radius: 50%;
      background: var(--dsw-static-neutral-bluish-1000, #10141c);
...
function BackgroundRow() {
      ...
      // Invisible occupant: captures session input actions + cwd without
      // taking any room in the composer tool row (no overlap).
      ...
      ctx.effect(() => {
        ...
        return () => { off1(); off2(); off2b(); off3(); off4(); off5(); off5b(); off5c(); off5d(); off6(); off7(); off8(); };
      }, "ui-mobile: slots");
    }
