window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .dshm-search-model-row .dshm-search-model-copy { flex-direction: column; flex: 1; min-width: 0; display: flex; }
    .dshm-search-model-row .dshm-search-model-name {
      color: inherit; text-overflow: ellipsis; white-space: nowrap; font-size: 14px; font-weight: 500; line-height: 20px; overflow: hidden;
    }
    .dshm-search-model-row .dshm-search-model-sub {
      color: var(--dsw-alias-label-tertiary, #81858c); text-overflow: ellipsis; white-space: nowrap; font-size: 12px; line-height: 18px; overflow: hidden;
    }
...
function BackgroundRow() {
      ...
      function ensureSearchModelRow() {
        ...
        copy.className = "dshm-search-model-copy _7KE1Ra_optionCopy";
