...
function BackgroundRow() {
      ...
      function PickerSheet() {
        ...
        if (!open) return null;
        return react.createElement(react.Fragment, null,
          react.createElement("div", { className: "dshm-picker-backdrop", onClick: () => setPickerOpen(false) }),
      ...
      ctx.effect(() => {
        ...
        return () => { off1(); off2(); off2b(); off3(); off4(); off5(); off5b(); off5c(); off5d(); off6(); off7(); off8(); off9(); };
      }, "ui-mobile: slots");
    }
