      ...
      function injectMessageActions(messages, sessionId) {
        ...
        const sync = () => {
          ...
          for (const row of rows) {
            ...
            row.appendChild(mkBtn(EDIT_PATH, t("msgEdit"), () => mountEditor(match, sessionId)));
            row.appendChild(mkBtn(TRASH_PATH, t("msgDelete"), () => {
            ...
            if (match.kind === "user") {
              row.appendChild(mkBtn(REFRESH_PATH, t("msgRegenerate"), () => {
