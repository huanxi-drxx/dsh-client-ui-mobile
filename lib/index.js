...
function editPlan(operation, turns) {
  ...
  if (event.type === "user/message") {
    ...
    if (!before || before.type !== "text") throw new Error("user block is not text");
  ...
  if (!isTextualBlock(before)) throw new Error("assistant block is not text/reasoning");
